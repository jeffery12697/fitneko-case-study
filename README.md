...
**Scale of the codebase:** ~15k LOC of application Go (including a ~1.2k-LOC end-to-end test harness), ~16k LOC of tests across 60 test files, 15 SQL migrations, 360+ commits.
